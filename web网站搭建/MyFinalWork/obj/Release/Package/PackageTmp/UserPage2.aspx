<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserPage2.aspx.cs" Inherits="MyFinalWork.UserPage2" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <!-- 导航栏 -->
            <div class="guide">
                ...
                <ul class="guideul" data-nav-item="navList">
                    ...
                    <li class="guideli" data-nav-item="navLink"><a href="userPage2.aspx" data-nav-item="navLinkInner" class="homepage-link">失物广场</a></li>
        ...
        <!-- 写一个lable标签 -->
            <div>
                <asp:Label ID="Label1" runat="server" Text="这里是失物广场，如果您发现了失物，请联系失主哦！" CssClass="Label0"></asp:Label>
            </div>
        <!-- 搜索框 -->
            <div>
        ...
        <!-- 遗失盒子 -->
            <div class="Lostbox">
                <div class="Lostbox1">
                    <div class="imgbox">
                         <img src="Lost.jpg" alt="图片">
                    </div>
                     <asp:Label ID="Label2" runat="server" Text="Label" CssClass="labelName"></asp:Label>
                     <br />
                     <asp:Label ID="Label3" runat="server" Text="失主：" CssClass="label0"></asp:Label>
                     ...
                     <br />
                     <asp:Label ID="Label7" runat="server" Text="丢失时间：" CssClass="label2"></asp:Label>
                     <asp:Label ID="Label8" runat="server" Text="Label" CssClass="label02"></asp:Label>
                     <br />
                     <asp:Label ID="Label9" runat="server" Text="丢失地点：" CssClass="label3"></asp:Label>
                    ...
                    <br />
                    <asp:Button ID="Button8" runat="server" Text="关闭" OnClick="Button8_Click" Visible="False" CssClass="CallBtn" BorderColor="White" />
                    <asp:Button ID="Button1" runat="server" Text="联系失主" CssClass="CallBtn" OnClick="Button1_Click" BorderColor="White" />
                </div>
                <div class="Lostbox2">
                    <div class="imgbox">
                         <img src="Lost.jpg" alt="图片">
                     ...
                     <br /><br />
                     <asp:Label ID="Label12" runat="server" Text="失主：" CssClass="label0"></asp:Label>
                     ...
                     <br /><br />
                     <asp:Label ID="Label16" runat="server" Text="丢失时间：" CssClass="label2"></asp:Label>
                     <asp:Label ID="Label17" runat="server" Text="Label" CssClass="label02"></asp:Label>
                     <br /><br />
                     <asp:Label ID="Label18" runat="server" Text="丢失地点：" CssClass="label3"></asp:Label>
                    ...
                    <br />
                    <asp:Button ID="Button2" runat="server" Text="联系失主" CssClass="CallBtn" OnClick="Button2_Click" BorderColor="White" />
                    <asp:Button ID="Button9" runat="server" Text="关闭" Visible="False" CssClass="CallBtn" OnClick="Button9_Click" BorderColor="White" />
                 </div>
                 <div class="Lostbox3">
                     <div class="imgbox">
                         <img src="Lost.jpg" alt="图片">
                     ...
                     <br /><br />
                     <asp:Label ID="Label21" runat="server" Text="失主：" CssClass="label0"></asp:Label>
                     ...
                     <br /><br />
                     <asp:Label ID="Label25" runat="server" Text="丢失时间：" CssClass="label2"></asp:Label>
                     <asp:Label ID="Label26" runat="server" Text="Label" CssClass="label02"></asp:Label>
                     <br /><br />
                     <asp:Label ID="Label27" runat="server" Text="丢失地点：" CssClass="label3"></asp:Label>
                    ...
                    <br />
                     <asp:Button ID="Button6" runat="server" Text="联系失主" CssClass="CallBtn" OnClick="Button6_Click" BorderColor="White" />
                     <asp:Button ID="Button10" runat="server" Text="关闭" Visible="False" CssClass="CallBtn" OnClick="Button10_Click" BorderColor="White" />
                 </div>
            </div>
        ...
        <!-- 发布失物 -->
            <div>
                <asp:Button ID="Button5" runat="server" Text="发布失物" OnClick="Button5_Click" BorderColor="White" />
            </div>
        </div>
    </form>
</body>
