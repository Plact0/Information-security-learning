<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdPage2.aspx.cs" Inherits="MyFinalWork.AdPage21" %>
        ...
        <div class="whole">
           <div class="box">
            ...
            <asp:GridView ID="GridView1" runat="server" OnPageIndexChanging="GridView1_PageIndexChanging" OnRowEditing="GridView1_RowEditing" OnRowCancelingEdit="GridView1_RowCancelingEdit" OnRowUpdated="GridView1_RowUpdated" OnRowUpdating="GridView1_RowUpdating" OnRowDeleting="GridView1_RowDeleting" AutoGenerateColumns="False">
                <Columns>
                    <asp:BoundField DataField="丢失事件编号" HeaderText="丢失事件编号"></asp:BoundField>
                    <asp:BoundField DataField="失物名称" HeaderText="失物名称"></asp:BoundField>
                    <asp:BoundField DataField="失主" HeaderText="失主"></asp:BoundField>
                    <asp:BoundField DataField="联系方法" HeaderText="联系方法"></asp:BoundField>
