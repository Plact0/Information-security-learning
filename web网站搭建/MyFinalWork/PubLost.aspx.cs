...
{
    public partial class PubLost : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (Page.IsValid)
            {
                ...
                try
                {
                    ...
                    StuSQL = "INSERT INTO Lost(失物名称,失主,丢失地点,丢失时间,联系方法,描述, 发布用户) VALUES('" + TextBox1.Text + "', '" + TextBox6.Text + "','" + TextBox2.Text + "', '"
        ...
        public static string UploadAndDisplayImage(HttpPostedFile file)
        {
            if (file != null && file.ContentLength > 0)
            {
                ...
                return baseUrl + "/TempImages/" + fileName;
            }
            return "";
        }
